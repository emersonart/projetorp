                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <div class="profile-info-inner">
                            <div class="profile-img">
                                <img src="<?php echo base_url('assets/img/profile/1.jpg');?>" alt="" style="border-radius: 50%;">
                            </div>
                    ...
                    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                        <div class="product-payment-inner-st res-mg-t-30 analysis-progrebar-ctn">
                            <ul id="myTabedu1" class="tab-review-design">
                                <li class="active"><a href="#description">Informações</a></li>
                                <!--li class=""><a href="#INFORMATION">Atualizar dados</a></li-->
                            </ul>
                            <!-- LISTA DE BIOGRAFIA -->
                                            ...
                                            <div class="review-content-section">
                                                ...
                                                <!--div class="row mg-t-30">
                                                    <div class="col-lg-12">
                                                        ...
                                                        <div class="content-profile"> < !-- DESCRIÇÃO  PERFIL >
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input name="number" type="text" class="form-control" placeholder="ex: Tiago">
                                                        </div>
                                                        <div class="form-group">
                                                            <label> Sobrenome:</label>
                                                            <input type="text" class="form-control" placeholder="ex: Dos Santos">
                                                        </div>
                                                        <label> Email:</label>
                                                        <div class="form-group">
                                                    ...
                                                    <div class="col-lg-6">
                                                        ...
                                                        <div class="form-group">
                                                            <label> Contato:</label>
                                                            <input type="text" class="form-control" placeholder="ex: 8491234567">
                                                        </div>
                                                        ...
                                                        <div class="file-upload-inner ts-forms">
                                                            <div class="input prepend-big-btn">
                                                                ...
                                                                <input type="text" id="prepend-big-btn" placeholder="Clique aqui para alterar foto">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <label> Descrição:</label>
                                                        <div class="form-group sm-res-mg-15 tbpf-res-mg-15">
                                                            <textarea type="text" class="form-control" placeholder="Escreva algo sobre você!"> </textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row mg-t-30">
                                                    <div class="col-lg-12">
                                                        <div class="payment-adress mg-t-15">
                                                            <button type="submit" class="btn btn-primary waves-effect waves-light mg-b-15">Alterar</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
